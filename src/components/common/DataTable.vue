...
<style type="text/postcss" scoped>
table {
  @apply bg-transparent w-full;
}
th {
  @apply py-4 px-3 text-left text-white font-light text-lg border-b border-solid border-gray-800 max-w-xs;
}
td {
  @apply py-4 px-3 text-left font-light text-gray-600 text-base whitespace-no-wrap overflow-hidden;
...
tfoot {
  @apply bg-gray-500 absolute bottom-0 py-2 px-4 pt-1;
  left: 50%;
  transform: translate(-50%, 0);
}
.filter {
  transform: translate(calc(9rem - 50%), 0);
}
</style>
<script>
export default {
